...
5. Write unit tests for core render states and semantic structure.
6. Verify placeholder content reads naturally outside the museum subject area.

## Positive tests

- Every component renders with a clean default case.
- Every component has at least one test.
- Components work with concept, process, and assignment content.
